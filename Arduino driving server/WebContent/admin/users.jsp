...
<ADS:ifPerm permission="userlist" minValue="READ">
	<div class="panel panel-default">
		<h1 class="panel title">
			Users
			<ADS:ifPerm permission="userlist" minValue="READ">
				<button class="btn btn-default" onclick="submit_new_user()"
		...
		<div class="panel-body">
			<div class="row">
				<%
					HashMap<Integer, User> users = Users.getInstance().getUsers();
				...
				<div class="col-md-3">
					<div class="panel panel-default">
						<div class="panel-heading panel-title">
							<ADS:ifPerm permission="bridge" minValue="ALL">
								<a class="btn btn-default"
									onclick="submit_edit_user('<%=user.getName()%>')"
								...
								%>
								<button onclick="setUserToDelete('<%=user.getName()%>')"
									type="button" class="btn btn-danger" data-toggle="modal"
									data-target="#modal_remove_user"
						...
						<div class="panel-body">
							<strong>Name</strong> :
							<%=user.getName()%><br> <strong>Password</strong> :
							<%=Users.getInstance().getPassword(user.getName())%><br> <strong>Group</strong>
							:
							<%=user.getPermissionsGroup()%>
						</div>
					</div>
				</div>
				<%
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					Are you sure you want to delete user <strong><span
						id="user_name"></span></strong> ?
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">No</button>
					<button type="button" class="btn btn-primary" data-dismiss="modal"
						onclick="submit_remove_user()">Yes</button>
				</div>
			</div>
		</div>
	</div>
...
<ADS:ifPerm permission="userlist" minValue="ALL">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				<label for="password">Password</label> <input class="form-control"
					...
					value="<%=Users.getInstance().getPassword(
									user.getName())%>" />
			</div>
			<div class="form-group">
				<label for="group">Group</label> <input class="form-control"
					type="text" id="group" placeholder="Group name"
	...
	<%
					...
					out.print("<div class=\"error\">There is any action named "
							+ action + " !</div>");
