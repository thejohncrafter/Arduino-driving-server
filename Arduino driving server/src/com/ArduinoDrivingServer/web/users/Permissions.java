...
/**
 * This singleton contains all the methods related to permissions.
 * 
...
public class Permissions {
	...
	/**
	 * This field stores the instance of the singleton.
	 */
	...
	/**
	 * This method is called at startup and is used to load all the permission
	 * names.
	 * 
	 * @throws IOException
	 *             Should never happen.
	 ...
	 *             Should never happen.
	 */
	private void loadPermissions() throws JDOMException, IOException {

		System.out
				.println("Loading all permission names form /WEB-INF/ADS-cfg.xml...");
	...
	/**
	 * This method loads the permissions groups from file (permisssions.xml in
	 * /WEB-INF/).
	 * 
	 * @throws JDOMException
	 *             If a <code>JDOMExcaption</code> occurs.
	 * @throws IOException
	 *             If an <code>IOExcaption</code> occurs.
	 */
	private void loadGroups() throws JDOMException, IOException {

		System.out
				.println("Loading permission groups from /WEB-INF/ADS-cfg.xml...");
		...
		for (int i = 0; i < groups.size(); i++) {
			...
			for (int i2 = 0; i2 < perms.size(); i2++) {
				...
				default:
					pValue = NONE;
					System.out
							.println("Error : bad value in attribute \"permission\" "
									+ "from permissions.groups(name = "
									+ name
									+ ").permission(name = "
									+ pValue_str
			...
			if (allPerms.size() != 0) {
				...
				System.out
						.println("\tWarning : missing permission(s). Filling it with default value (NONE)");
				...
				output.output(group.getDocument(), new FileOutputStream(
						ArduinoDriving.getRealPath("WEB-INF/permissions.xml")));
	...
	/**
	 * This method is used to register a permissions group. <div
	 * style="color:red;"> Make sure you gave a correct <code>HashMap</code>
	 * because validity won't be tested. </div>
	 * 
	 * @param name
	 *            The name of the group.
	 * @param perms
	 *            A <code>HashMap</code> used to store the permissions.
	 * @throws IOException
	 *             Should never happen.
	 * @throws JDOMException
	 *             Should never happen.
	 */
	public void createGroup(String name, HashMap<String, Integer> perms)
	 ...
	 *             Should never happen.
	 */
	public void removeGroup(String name) throws FileNotFoundException,
	 ...
	 * 
	 * @param oldName
	 *            The old name of the group (if renaming).
	 * @param name
	 *            The new name of the group (if renaming).
	 * @param perms
	 *            The new permissions.
	 * @throws IOException
	 *             Should never happen.
	 ...
	 *             Should never happen.
	 */
	public void editGroup(String oldName, String name,
			HashMap<String, Integer> perms) throws JDOMException, IOException {
	...
	/**
	 * This method is used to get a user's permission. It will always return
	 * <code>Permissions.ALL</code> if the user's permissions group is "sudo".
	 * If the permission is null, it returns <code>Permissions.NONE</code>.
	 * 
	 * @param user
	 *            The user.
	 * @param permission
	 ...
	 */
	public int getPermission(User user, String permission) {
	...
	/**
	 * This method is used to get the group (a
	 * <code>HashMap<String, Integer></code> that stores all the permissions)
	 ...
	 * @return The group.
	 */
	public HashMap<String, Integer> getGroup(String name) {
	...
	public int getGroupIndex(String gName) {
		...
		Integer[] keys = groupNames.keySet().toArray(
				new Integer[groupNames.size()]);
	 ...
	 * 
	 * @param perm
	 *            The permission to get as String.
	 * @return The permission as String.
	 * @see Permissions#NONE
	 * @see Permissions#READ
	 * @see Permissions#ALL
	 */
	public String getPermissionAsString(int perm) {
	 ...
	 * If you want to get a special group, it is better to use
	 * <code>getGroup()</code>.
	 * 
	 * @return All the groups.
	 * @see Permissions#getGroup(String)
	 */
	public HashMap<Integer, HashMap<String, Integer>> getGroups() {
		return groups;
	}
	 ...
	 * 
	 * @return The instance if it exists, else it creates and returns it.
	 */
	public static Permissions getInstance() {

		return instance != null ? instance : (instance = new Permissions());
