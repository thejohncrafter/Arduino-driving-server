...
public class PermissionsTag implements Tag {
	 ...
	 * Note : this field is a <code>Integer</code> because the class needs to
	 * know if it has been defined (via <code>setMinValue())
	 * 
	 * @see setMinValue
	 */
	 ...
	 * shown if the permission is > than needed).
	 */
	...
	public int doStartTag() throws JspException {
		...
		if (permission == null || minVal == null)
			throw new NullPointerException(
					"Missing permission and/or minimum value !");
	 ...
	 *             If the given argument isn't one of the accepted arguments.
	 */
	public void setMinValue(String val) {
		...
		default:
			throw new IllegalArgumentException(
					"minValue must be NONE, READ or ALL. You given " + val);
