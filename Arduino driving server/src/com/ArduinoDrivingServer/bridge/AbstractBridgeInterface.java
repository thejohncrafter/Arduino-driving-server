...
/**
 * This class is used to create <code>PortBridge</code>s and
 * <code>VirtualPort</code>s.
 * 
...
public abstract class AbstractBridgeInterface {
	...
	/**
	 * This field stores the type of bridge where the interface was created
	 * (USB, bluetooth,...).
	 */
	...
	/**
	 * This method is used to read a line from the input stream until a given
	 * timeout.<br>
	 * It waits for data and returns the read line.
	 * 
	 * @param timeout
	 ...
	 *             If an error occurs.
	 */
	public abstract String readLine(String line, long timeout)
	...
	/**
	 * This method is used to get the name of the bridge where the interface was
	 * created (USB, bluetooth,...).
	 * 
	...
	/**
	 * This method is used to set the name of the bridge where the interface was
	 * created (USB, bluetooth,...). It is called when the bridge name changes.
	 * 
	 * @param name
	 *            The new parent bridge name.
	 */
