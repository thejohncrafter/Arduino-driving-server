...
public abstract class AbstractBridge {
	...
	/**
	 * This method is called by Bridge when closing. All the
	 * <code>AbstractBridgeInterface</code> are closed before closing the
	 * bridge.
	 * 
	...
	/**
	 * This method id used to set the "activated" property of the bridge. <div
	 * style="color:red;">But it does not change bridge's state (use
	 * <code>init()</code> and <code>destroy</code> for this) !</div>
	 * 
	 * @param activated
	 *            The new value of the "activated" property.
	 * @see init
	 * @see destroy
	 */
	...
	/**
	 * This method is used to get the bridge's ID (found in
	 * <code>bridge.xml</code>).
	 * 
	...
	/**
	 * This method is used to set the bridge's ID (found in
	 * <code>bridge.xml</code>).
	 * 
	 * @param id
	 *            The bridge's ID.
