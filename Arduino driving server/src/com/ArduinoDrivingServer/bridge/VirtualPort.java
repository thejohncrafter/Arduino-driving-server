...
/**
 * This class is used to create a <code>"virtual"</code> port : a port fully
 * handled by the porgramm (used for driver creation).
 * 
...
public class VirtualPort extends AbstractBridgeInterface {
	...
	/**
	 * This constructor defines the name and the HID of the port. It also
	 * defines <code>virtual</code> to <code>true</code> on <code>super</code>.
	 * 
	 * @param name
	 *            The name of the emulated port.
	 * @param hid
	 *            the port's HID.
	 */
	 ...
	 * It also defines <code>virtual</code> to <code>true</code> on
	 * <code>super</code>.
	 * 
	 * @param name
	 *            The name of the emulated port.
